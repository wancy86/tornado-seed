...
class T(AuthorizedTestCase):
    ...
    @property
    def path(self):
        return '/service/secu/favorite_item'
    ...
    def setUp(self):
        ...
        query = '''
            insert into todo_favorite_item(itemid, userid) values (:itemid, :userid);
        '''
    ...
    def test_by_correct_info(self):
        ...
        query = '''
            select count(1) from todo_favorite_item where userid=:userid and itemid=:itemid;
        '''
